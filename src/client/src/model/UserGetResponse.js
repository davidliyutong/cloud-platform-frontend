...
class UserGetResponse {
    ...
    constructor(status, message) { 
        ...
        UserGetResponse.initialize(this, status, message);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserGetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserGetResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserGetResponse.RequiredProperties) {
            if (!data[property]) {
...
UserGetResponse.RequiredProperties = ["status", "message"];

/**
 * @member {String} description
 * @default ''
 */
UserGetResponse.prototype['description'] = '';

/**
 * @member {Number} status
 */
UserGetResponse.prototype['status'] = undefined;
