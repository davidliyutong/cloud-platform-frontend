...
/**
 * The TemplateCreateResponse model module.
 * @module model/TemplateCreateResponse
 * @version 1.0.0
 */
class TemplateCreateResponse {
    ...
    /**
     * Constructs a <code>TemplateCreateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateCreateResponse} obj Optional instance to populate.
     * @return {module:model/TemplateCreateResponse} The populated <code>TemplateCreateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateCreateResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateCreateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateCreateResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TemplateCreateResponse.RequiredProperties) {
            if (!data[property]) {
 ...
 */
TemplateCreateResponse.prototype['template'] = undefined;
...
export default TemplateCreateResponse;
