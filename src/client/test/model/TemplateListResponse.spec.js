...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.TemplateListResponse();
  });
  ...
  describe('TemplateListResponse', function() {
    it('should create an instance of TemplateListResponse', function() {
      // uncomment below and update the code to test TemplateListResponse
      //var instance = new Api.TemplateListResponse();
      //expect(instance).to.be.a(Api.TemplateListResponse);
    });
