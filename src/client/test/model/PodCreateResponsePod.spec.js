...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PodCreateResponsePod();
  });
  ...
  describe('PodCreateResponsePod', function() {
    it('should create an instance of PodCreateResponsePod', function() {
      // uncomment below and update the code to test PodCreateResponsePod
      //var instance = new Api.PodCreateResponsePod();
      //expect(instance).to.be.a(Api.PodCreateResponsePod);
    });
