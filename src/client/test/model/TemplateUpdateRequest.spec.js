...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.TemplateUpdateRequest();
  });
  ...
  describe('TemplateUpdateRequest', function() {
    it('should create an instance of TemplateUpdateRequest', function() {
      // uncomment below and update the code to test TemplateUpdateRequest
      //var instance = new Api.TemplateUpdateRequest();
      //expect(instance).to.be.a(Api.TemplateUpdateRequest);
    });
