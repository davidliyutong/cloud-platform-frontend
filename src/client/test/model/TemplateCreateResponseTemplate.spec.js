...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.TemplateCreateResponseTemplate();
  });
  ...
  describe('TemplateCreateResponseTemplate', function() {
    it('should create an instance of TemplateCreateResponseTemplate', function() {
      // uncomment below and update the code to test TemplateCreateResponseTemplate
      //var instance = new Api.TemplateCreateResponseTemplate();
      //expect(instance).to.be.a(Api.TemplateCreateResponseTemplate);
    });
