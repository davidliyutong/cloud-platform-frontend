...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.TemplateCreateRequest();
  });
  ...
  describe('TemplateCreateRequest', function() {
    it('should create an instance of TemplateCreateRequest', function() {
      // uncomment below and update the code to test TemplateCreateRequest
