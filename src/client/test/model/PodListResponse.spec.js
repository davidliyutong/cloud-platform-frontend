...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PodListResponse();
  });
  ...
  describe('PodListResponse', function() {
    it('should create an instance of PodListResponse', function() {
      // uncomment below and update the code to test PodListResponse
      //var instance = new Api.PodListResponse();
      //expect(instance).to.be.a(Api.PodListResponse);
    });
